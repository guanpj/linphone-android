...
import com.longrise.jie.sample2.campatibility.Compatibility;
import com.longrise.jie.sample2.campatibility.CompatibilityScaleGestureDetector;
import com.longrise.jie.sample2.campatibility.CompatibilityScaleGestureListener;
...
public class CallVideoFragment extends Fragment implements OnGestureListener, OnDoubleTapListener, CompatibilityScaleGestureListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		View view;
		if (LinphoneMiniManager.getLc().hasCrappyOpenGL()) {
		...
		androidVideoWindowImpl = new AndroidVideoWindowImpl(mVideoView, mCaptureView, new AndroidVideoWindowImpl.VideoWindowListener() {
			...
			public void onVideoPreviewSurfaceReady(AndroidVideoWindowImpl vw, SurfaceView surface) {
				...
				LinphoneMiniManager.getLc().setPreviewWindow(mCaptureView);
			}
